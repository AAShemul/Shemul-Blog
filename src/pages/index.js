	...
	return (
		<header className={clsx('hero hero--primary', styles.heroBanner)}>
			<div className="container">
				<div className="center"><img className="shemul" src="/img/AAShemul.webp" alt="Md. Ashraful Alam Shemul at Jahangirnagar University (May 28, 2022)" /></div>
	...
	return (
		<Layout
			...
			<Head>
				...
				<meta property="og:description" content="Shemul's Blog is a content sharing website of Md. Ashraful Alam Shemul. Md. Ashraful Alam Shemul is a Bangladeshi Author, teacher and tech-enthusiastic. He is studying Marine Fisheies in Bangabandhu Sheikh Mujibur Rahman Maritime University." />
				...
				<meta name="twitter:description" content="Shemul's Blog is a content sharing website of Md. Ashraful Alam Shemul. Md. Ashraful Alam Shemul is a Bangladeshi Author, teacher and tech-enthusiastic. He is studying Marine Fisheies in Bangabandhu Sheikh Mujibur Rahman Maritime University." />
